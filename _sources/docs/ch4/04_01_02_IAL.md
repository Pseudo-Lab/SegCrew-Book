...
<img src="pic/ial/ial1.png" alt="ial1" class="bg-primary mb-1" width="600px">
...
:::{figure-md} markdown-fig
<img src="pic/ial/ial2.png" alt="ial2" class="bg-primary mb-1" width="600px">

Fig. 4 Illustration of mining confident regions
:::
