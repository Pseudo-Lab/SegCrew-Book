...
<img src="pic/YOLACT/figure1.png" alt="figure1" class="bg-primary mb-1" width="600px">

Figure 1. Speed-performance trade-off
:::
...
:::{figure-md} markdown-fig
<img src="pic/YOLACT/figure2.png" alt="figure2" class="bg-primary mb-1" width="600px">
...
:::{figure-md} markdown-fig
<img src="pic/YOLACT/figure3.png" alt="figure3" class="bg-primary mb-1" width="600px">

Figure 5. Prototype behavior
:::
